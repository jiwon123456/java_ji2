			...
			case 3:// 학생성적수정
				while(true) {
					...
					if (count == 0) {// 검색된 이름이 없으면
						System.out.println("학생이 검색되지 않았습니다. 다시입력하세요.");
						continue; // switch 빠져나옴
					} // if
					System.out.println("--------------------------------");
					...
					case 1:
						...
						s.list.get(i).setKor(scan.nextInt()); //입력받자마자 바로 저장
					...
					case 2:
						...
						s.list.get(i).setEng(scan.nextInt()); //입력받자마자 바로 저장
						s.list.get(i).setTotal(s.list.get(i).getKor()+s.list.get(i).getEng()
								+s.list.get(i).getMath());
						s.list.get(i).setAvg(s.list.get(i).getTotal()/3.0);
						System.out.println("---------------------------");
					...
					case 3:
						...
						s.list.get(i).setMath(scan.nextInt()); //입력받자마자 바로 저장
						s.list.get(i).setTotal(s.list.get(i).getKor()+s.list.get(i).getEng()
								+s.list.get(i).getMath());
						s.list.get(i).setAvg(s.list.get(i).getTotal()/3.0);
						System.out.println("---------------------------");
